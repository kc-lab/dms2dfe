...
`dms2dfe` is an integrative analysis workflow designed for end-to-end analysis of Deep Mutational Scanning [@Fowler2014a] data. Using this workflow, users can implement various processing methods and downstream applications for pair-wise enrichment analysis of ultra-deep sequencing data.
