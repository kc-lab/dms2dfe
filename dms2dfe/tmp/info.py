...
fsta_fh='APH2_Melnikov_et_al_2014_split_tests/aph_wt_nt_cctmr.fasta' #Optional: Path to reference fasta file
pdb_fh='APH2_Melnikov_et_al_2014_split_tests/1ND4.pdb' #Optional: Path to pdb file
